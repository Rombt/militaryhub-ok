{* Title *}
{$meta_title=$btr->products_types_title scope=parent}
    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                {$btr->products_types|escape} - {$items_count}
            </div>
            <div class="box_btn_heading">
                <a class="btn btn_small btn-info" href="{url module=ProductsTypeAdmin return=$smarty.server.REQUEST_URI}">
                    {include file='svg_icon.tpl' svgId='plus'}
                    <span>{$btr->products_type_add|escape}</span>
                </a>
            </div>
        </div>
    </div>
...
<div class="boxed fn_toggle_wrap">
        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_items_name">{$btr->general_name|escape}</div>
                        ...
                        <div class="fn_row main_list_body_item fn_sort_item">
                            <div class="main_list_row ">
                                ...
                                <div class="main_list_boding main_list_photo">
                                    {if $item->image}
                                        <a href="{url module=ProductTypeAdmin id=$item->id return=$smarty.server.REQUEST_URI}">
                                            <img src="{$item->image|resize:55:55:false:$config->resized_types_dir}" alt="" /></a>
                                    {else}
                                        <img height="55" width="55" src="design/images/no_image.png"/>
                                    {/if}
                                </div>

                                <div class="main_list_boding main_list_items_name">
                                    <a href="{url module=ProductsTypeAdmin id=$item->id return=$smarty.server.REQUEST_URI}">
                                        {$item->name|escape}
                                    </a>
                                </div>
                                ...
                                <div class="main_list_boding main_list_status">
                                    {*visible*}
                                     <label class="switch switch-default ">
                                        <input class="switch-input fn_ajax_action {if $item->visible}fn_active_class{/if}" data-module="products_types" data-action="visible" data-id="{$item->id}" name="visible" value="1" type="checkbox"  {if $item->visible}checked=""{/if}/>
                                ...
                                <div class="main_list_setting">
                                    {* <a href="../{$lang_link}types/{$item->url|escape}" target="_blank" data-hint="{$btr->general_view|escape}" class="setting_icon setting_icon_open hint-bottom-middle-t-info-s-small-mobile  hint-anim">
                                ...
                                <div class="main_list_boding main_list_close">
                                    {*delete*}
                                    <button data-hint="{$btr->products_type_delete|escape}" type="button" class="btn_close fn_remove hint-bottom-right-t-info-s-small-mobile  hint-anim" data-toggle="modal" data-target="#fn_action_modal" onclick="success_action($(this));">
                ...
                <div class="main_list_footer fn_action_block">
                    <div class="main_list_foot_left">
                        ...
                        <div class="main_list_option">
                            <select name="action" class="selectpicker items_action">
    ...
    {else}
        <div class="heading_box mt-1">
            <div class="text_grey">{$btr->products_types_no|escape}</div>
        </div>
    {/if}
</div>
...
{literal}
    <script>
        $(function() {
            $(document).on('change', '.fn_action_block select.items_action', function () {
