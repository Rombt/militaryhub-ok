                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="main_list">
                            <div class="main_list_head">
                                <div class="main_list_heading feature_option_name">{$btr->feature_feature_alias_value|escape}</div>
                                <div class="main_list_heading feature_option_aliases">{$btr->feature_option_aliases_value|escape}</div>
                            </div>
                            <div class="main_list_body">
                                {foreach $features_values as $fv}
                                    <div class="fn_row okay main_list_body_item">
                                        <div class="main_list_row">
                                            <div class="main_list_boding feature_option_name">
                                                <div class="heading_box visible_xs">{$btr->feature_feature_alias_value|escape}</div>
                                                {$fv->value|escape}
                                            </div>
                                            <div class="main_list_boding feature_option_aliases">
