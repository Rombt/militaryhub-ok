                ...
                <form method="post" class="fn_form_list">
                    ...
                    <div class="post_wrap main_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_comments_name">{$btr->general_messages|escape}</div>
                            <div class="main_list_heading main_list_comments_btn"></div>
                        ...
                        <div class="main_list_body">
                            {function name=comments_tree level=0}
                                {foreach $feedbacks as $feedback}
                                    <div class="fn_row main_list_body_item {if $level > 0}admin_note2{/if}">
                                        <div class="main_list_row">
                                            <div class="main_list_boding main_list_check">
                                                ...
                                                <label class="main_ckeckbox" for="id_{$feedback->id}"></label>
                                            </div>

                                            <div class="main_list_boding main_list_comments_name {if $level > 0}admin_note{/if}">
                                                <div class="main_list_text_inline mb-q mr-1">
                                                    <span class="text_dark text_bold">{$btr->general_name|escape} </span> {$feedback->name|escape}
                                                </div>
                                                <div class="main_list_text_inline mb-q">
                                                ...
                                                {if $feedback->user_id}
                                                <div class="main_list_text_inline mb-q">
                                                    <span class="text_dark text_bold">Пользователь: </span> <a href="{url module='UserAdmin' id=$feedback->user_id}">{$feedback->user_name}</a>
                                                </div>
                                                {/if}
                                                <div>
                                            ...
                                            <div class="main_list_boding main_list_comments_btn">
                                                {if !$feedback->processed}
                                                    <button type="button" class="btn btn_small btn-outline-warning fn_ajax_action {if $feedback->processed}fn_active_class{/if}" data-module="feedback" data-action="processed" data-id="{$feedback->id}" onclick="$(this).hide();">
                                                        {$btr->general_process|escape}
                                                    </button>
            ...
            <div class="modal-body">
                <form class="form-horizontal " method="post">
                    ...
                    <div class="form-group">
                        <textarea class="fn_comment_area form-control main_textarea" placeholder="{$btr->general_enter_answer|escape}" name="text" rows="10" cols="50"></textarea>
                    </div>
