    ...
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="mb-1">
                     <textarea name="auto_meta_desc" class="form-control main_textarea fn_ajax_area">{$category->auto_meta_desc|escape}</textarea>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <div class="mb-1">
            <textarea name="auto_description" class="main_textarea fn_ajax_area">{$category->auto_description|escape}</textarea>
        </div>
    </div>
</div>
<div class="row">
