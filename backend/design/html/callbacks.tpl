                ...
                <form class="fn_form_list" method="post">
                    ...
                    <div class="post_wrap main_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_comments_name">{$btr->callbacks_requests|escape}</div>
                                ...
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row">
                                        <div class="main_list_boding main_list_check">
                                            ...
                                            <label class="main_ckeckbox" for="id_{$callback->id}"></label>
                                        </div>

                                        <div class="main_list_boding main_list_comments_name">
                                            ...
                                            <div>
                                                {if $callback->type}
                                                    <span class="tag tag-danger">{$btr->get_translation("callback_type_{$callback->type}")}</span>
                                                {else}
                                                    <span class="tag tag-danger">{$btr->get_translation("callback_type_default")}</span>
                                                {/if}
                                            </div>
                                            <div>
