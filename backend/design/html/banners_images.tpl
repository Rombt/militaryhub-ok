        ...
        {if $banners_images}
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form class="fn_form_list" method="post">
                    <div id="main_list" class=" main_list products_list fn_sort_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_brands_photo">{$btr->general_image|escape}</div>
                            <div class="main_list_heading main_list_bransimages_name">{$btr->general_name|escape}</div>
                            <div class="main_list_heading main_list_brands_group">{$btr->general_banner_group|escape}</div>
                        ...
                        {*Параметры элемента*}
                        <div class="banners_wrap main_list_body features_wrap sortable">
                                ...
                                <div class="fn_row main_list_body_item fn_sort_item">
                                    <div class="main_list_row">
                                        ...
                                        <div class="main_list_boding main_list_check">
                                            ...
                                            <label class="main_ckeckbox" for="id_{$banners_image->id}"></label>
                                        </div>

                                        <div class="main_list_boding main_list_brands_photo">
                                        ...
                                        <div class="main_list_boding main_list_bransimages_name">
                                            ...
                                            <div class="main_list_name_brand">
                                                {$banners_image->image}
                                            </div>
                                        </div>

                                        <div class="main_list_boding main_list_brands_group">
                                            {if $banners}
