        ...
        <form method="post" class="fn_form_list">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_languages_name">{$btr->general_name|escape}</div>
                        ...
                        <div class="fn_row main_list_body_item fn_sort_item">
                            <div class="main_list_row">
                                ...
                                <div class="main_list_boding main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="id_{$language->id}"></label>
                                </div>
                                ...
                                <div class="main_list_boding main_list_languages_name">
                                    <a href="{url module=LanguageAdmin id=$language->id return=$smarty.server.REQUEST_URI}">
