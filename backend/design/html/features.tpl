        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_features_name">{$btr->general_name|escape}</div>
                    <div class="main_list_heading main_list_features_tag">{$btr->general_categories|escape}</div>
                    <div class="main_list_heading main_list_url_status">{$btr->feature_url_in_product_short|escape}</div>
                    <div class="main_list_heading main_list_status">{$btr->features_in_filter|escape}</div>
                    <div class="main_list_heading main_list_setting main_list_features_setting">{$btr->general_activities|escape}</div>
                    <div class="main_list_heading main_list_close"></div>
                </div>
                {*Параметры элемента*}
                <div class="main_list_body features_wrap sort_extended">
                    ...
                    <div class="fn_row main_list_body_item fn_sort_item">
                        <div class="main_list_row ">
                            ...
                            <div class="main_list_boding main_list_check">
                                ...
                                <label class="main_ckeckbox" for="id_{$feature->id}"></label>
                            </div>

                            <div class="main_list_boding main_list_features_name">
                                <a class="link" href="{url module=FeatureAdmin id=$feature->id return=$smarty.server.REQUEST_URI}">
                                    {$feature->name|escape}
                                </a>
                            </div>

                            <div class="main_list_boding main_list_features_tag">
                                <div class="wrap_tags">
                            ...
                            <div class="main_list_boding main_list_url_status">
                                {*url_in_product*}
                            ...
                            <div class="main_list_boding main_list_setting main_list_features_setting">
                                {*yandex*}
