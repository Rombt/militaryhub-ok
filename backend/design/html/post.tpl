                            ...
                            <div class="col-lg- hidden">
                                <div class="">
                                    ...
                                    <select name="type_post" class="selectpicker mb-1">
                                        <option value="blog" selected="" >{$btr->blog_articles|escape}</option>
{*                                        <option value="news" {if $post->type_post == "news"}selected=""{/if} >{$btr->blog_one_news|escape}</option>*}
            ...
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <div class="toggle_body_wrap on fn_card fn_sort_list">
                    <div class="main_list ok_related_list">
                        <div class="main_list_body sortable related_products ">
                            ...
                            {/foreach}
                            <div id="new_related_product" class="fn_row okay main_list_body_item fn_sort_item" style='display:none;'>
                                <div class="main_list_row">
                                    <div class="main_list_boding main_list_drag move_zone">
                                        {include file='svg_icon.tpl' svgId='drag_vertical'}
                                    </div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <input name="author" class="form-control fn_meta_field mb-h" type="text"
                       value="{$post->author|escape}"/>
            </div>
        </div>
        {*Рейтинг*}
        <div class="col-lg-4 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    ...
                    <div class="raiting_boxed">
                        ...
                        <input class="fn_rating range_input" type="range" min="0" max="5" step="0.1" value="{$post->rating}" />
        ...
        <div class="col-lg-4 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <input name="views" class="form-control fn_meta_field mb-h" type="number"
                       value="{$post->views}"/>
            </div>
        </div>
    </div>
            ...
            <div class="boxed match fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card row">
                    ...
                    <div class="col-lg-6 col-md-6 pl-0">
                        ...
                        <textarea name="meta_description" class="form-control main_textarea fn_meta_field">{$post->meta_description|escape}</textarea>
                    </div>
                </div>
            </div>
        </div>
