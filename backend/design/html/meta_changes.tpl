{* Title *}
{$meta_title = $btr->general_metachanges scope=parent}
    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                {$btr->general_metachanges|escape}
            </div>
            <div class="box_btn_heading">
                <a class="btn btn_small btn-info" href="{url module=MetaChangeAdmin}">
                    {include file='svg_icon.tpl' svgId='plus'}
                    <span>{$btr->metachanges_add|escape}</span>
                </a>
            </div>
        </div>
    </div>
...
<div class="boxed fn_toggle_wrap">
                ...
                <form id="list_form" method="post" class="fn_form_list fn_fast_button">
                    ...
                    <div class="pages_wrap main_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_page_name">{$btr->metachanges_name|escape}</div>
                        ...
                        <div id="sortable" class="main_list_body sortable">
                            {foreach $meta_changes as $meta_change}
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row">
                                        <input type="hidden" name="positions[{$meta_change->id}]" value="{$meta_change->id}">
                                        ...
                                        <div class="main_list_boding main_list_check">
                                            <input class="hidden_check" type="checkbox" id="id_{$meta_change->id}" name="check[]" value="{$meta_change->id}"/>
                                            <label class="main_ckeckbox" for="id_{$meta_change->id}"></label>
                                        </div>

                                        <div class="main_list_boding main_list_page_name">
                                            <a href="{url module=MetaChangeAdmin id=$meta_change->id return=$smarty.server.REQUEST_URI}">
                                                {$meta_change->url|escape}
                                            </a>
                                        </div>
                                        ...
                                        <div class="main_list_setting main_list_pages_setting">
                                            {*open*}
                                            <a href="../{$lang_link}{$meta_change->url|escape}" target="_blank" data-hint="{$btr->general_view|escape}" class="setting_icon setting_icon_open hint-bottom-middle-t-info-s-small-mobile  hint-anim">
                                        ...
                                        <div class="main_list_boding main_list_close">
                                            {*delete*}
                                            <button data-hint="{$btr->metachanges_delete|escape}" type="button" class="btn_close fn_remove hint-bottom-right-t-info-s-small-mobile  hint-anim" data-toggle="modal" data-target="#fn_action_modal" onclick="success_action($(this));">
    ...
    {else}
        <div class="heading_box mt-1">
            <div class="text_grey">{$btr->metachanges_no|escape}</div>
        </div>
    {/if}
</div>
