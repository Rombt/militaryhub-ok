...
class Languages extends Okay
{
    ...
    {
        $fields['categories'] = array('name', 'name_h1', 'meta_title', 'meta_keywords', 'meta_description', 'annotation', 'description', 'auto_meta_title', 'auto_meta_keywords', 'auto_meta_desc', 'auto_description', 'parent_menu_name');
        $fields['brands'] = array('name', 'meta_title', 'meta_keywords', 'meta_description', 'annotation', 'description');
        $fields['products'] = array('name', 'meta_title', 'meta_keywords', 'meta_description', 'annotation', 'description', 'special', 'automatic_translation_done');
        ...
        $fields['banners_images'] = array('name', 'alt', 'title', 'annotation', 'description', 'url');
        ...
        /* products_types */
        $fields['products_types'] = array('name', 'meta_title', 'meta_keywords', 'meta_description');
        /* products_types */
        /* stores */
        $fields['stores'] = array('name', 'address');
        /* stores */
    ...
    {
        $this->lang_id = intval($id);
        if ($_SESSION['lang_id'] !== $this->lang_id) {
