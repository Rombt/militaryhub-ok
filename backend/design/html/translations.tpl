...
<div class="boxed fn_toggle_wrap">
    <form class="fn_form_list" method="post">
        ...
        <div class="translation_wrap main_list products_list fn_sort_list">
            <div class="main_list_head">
                ...
                <div class="main_list_heading main_list_translations_num">
                    <span>№</span>
                </div>
                <div class="main_list_heading main_list_translations_name">
                ...
                <div class="main_list_heading main_list_translations_variable">
            ...
            <div class="main_list_body">
                {foreach $translations as $label=>$value}
                    <div class="fn_row main_list_body_item fn_sort_item"{if !$translations_template[$label]} title="{$btr->translations_system_translation}"{/if}>
                        <div class="main_list_row ">
                            <div class="main_list_boding main_list_check">
                                ...
                                <label class="main_ckeckbox" for="{$label}"></label>
                            </div>
                            <div class="main_list_heading main_list_translations_num">№ {$value@iteration}</div>
                            <div class="main_list_boding main_list_translations_name">
                                <a href="{url module=TranslationAdmin id=$label return=$smarty.server.REQUEST_URI}">{$value|escape}</a>
                            </div>
                            <div class="main_list_boding  main_list_translations_variable">
