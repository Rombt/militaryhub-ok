        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_brands_name">{$btr->general_name|escape}</div>
                        ...
                        <div class="fn_row main_list_body_item fn_sort_item">
                            <div class="main_list_row ">
                                ...
                                <div class="main_list_boding main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="id_{$brand->id}"></label>
                                </div>
                                ...
                                <div class="main_list_boding main_list_brands_name">
                                    <a href="{url module=BrandAdmin id=$brand->id return=$smarty.server.REQUEST_URI}">
                                        {$brand->name|escape}
                                    </a>
                                </div>
                                ...
                                <div class="main_list_setting">
                                    ...
                                    <button data-hint="{$btr->brand_rozetka_exclude|escape}" type="button" class="setting_icon setting_icon_exclude fn_ajax_action {if $brand->rozetka_exclude}fn_active_class{/if} hint-bottom-middle-t-info-s-small-mobile  hint-anim" data-module="brand" data-action="rozetka_exclude" data-id="{$brand->id}" >
                                        R
                                    </button>
                                </div>
                    ...
                    <div class="main_list_foot_left">
                        ...
                        <div class="main_list_option">
                            <select name="action" class="selectpicker brands_action">
                                ...
                                <option value="in_feed_rozetka">{$btr->general_add_xml_short_rozetka|escape}</option>
                                <option value="out_feed_rozetka">{$btr->general_from_xml_short_rozetka|escape}</option>
                                <option value="in_feed_prom">{$btr->general_add_xml_short_prom|escape}</option>
                                <option value="out_feed_prom">{$btr->general_from_xml_short_prom|escape}</option>
                                <option value="in_feed_rss">{$btr->general_add_xml_short_rss|escape}</option>
                                <option value="out_feed_rss">{$btr->general_from_xml_short_rss|escape}</option>
