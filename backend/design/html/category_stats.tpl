    ...
    <form method="post" class="fn_form_list">
        ...
        <div class="main_list products_list fn_sort_list">
            ...
            <div class="main_list_head">
                <div class="main_list_heading main_list_categorystats_categories">{$btr->general_category|escape}</div>
                <div class="main_list_heading main_list_categorystats_total">{$btr->general_sales_amount|escape}</div>
                <div class="main_list_heading main_list_categorystats_setting">{$btr->general_amount|escape}</div>
            </div>
            {*Параметры элемента*}
                        ...
                        {if $categories}
                            <div class="main_list_body_item">
                                <div class="main_list_row ">
                                    <div class="main_list_boding main_list_categorystats_categories">
                                    ...
                                    <div class="main_list_boding main_list_categorystats_total">
                                        {if $category->price}<span class="text_dark">{$category->price} {$currency->sign}</span>{else}{$category->price} {$currency->sign}{/if}
                                    </div>
                                    <div class="main_list_boding main_list_categorystats_setting">
