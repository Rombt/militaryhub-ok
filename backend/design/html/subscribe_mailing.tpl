        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form class="fn_form_list" method="post">
                    ...
                    <div class="users_wrap main_list">
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_subscribe_name">{$btr->subscribe_mailing_email|escape}</div>
                            ...
                            {foreach $subscribes as $subscribe}
                                <div class="fn_row main_list_body_item">
                                    ...
                                    <div class="main_list_boding main_list_check">
                                        ...
                                        <label class="main_ckeckbox" for="id_{$subscribe->id}"></label>
                                    </div>

                                    <div class="main_list_boding main_list_subscribe_name">
