    ...
    <div class="row">
        <div class="col-lg-4 col-md-12 pr-0">
            <div class="boxed match fn_toggle_wrap">
                <div class="heading_box">
                    {$btr->general_system|escape}Системная информация
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                        <a class="btn-minimize" href="javascript:;" ><i class="icon-arrow-down"></i></a>
                    </div>
                </div>
                <div class="toggle_body_wrap on fn_card">
                    <div class="heading_label">{$btr->general_1C_ID|escape}Ид 1С</div>
                    <input class="form-control mb-1" type="text" disabled readonly value="{$feature->external_id|escape}"/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="toggle_body_wrap on fn_card fn_sort_list">
                    ...
                    <div class="main_list ok_related_list">
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading feature_value_name">{$btr->feature_value_name}</div>
                            <div class="main_list_heading feature_value_translit">{$btr->feature_value_translit}</div>
                            <div class="main_list_heading feature_value_products_num">{$btr->feature_value_products_num}</div>
                            <div class="main_list_heading feature_value_index">
                        ...
                        <div class="main_list_body fn_feature_values_list sort_extended fn_values_list">
                            {foreach $features_values as $fv}
                                <div class="fn_row okay main_list_body_item fn_sort_item">
                                    <div class="main_list_row">
                                        ...
                                        <div class="main_list_boding feature_value_name">
                                        ...
                                        <div class="main_list_boding feature_value_translit">
                                            <div class="heading_label visible_md">{$btr->feature_value_translit}</div>
                                            <input type="text" class="form-control fn_feature_alias_name" name="feature_values[translit][]" value="{$fv->translit|escape}" readonly />
                                        </div>
                                        <div class="main_list_boding feature_value_products_num">
                                        ...
                                        <div class="main_list_boding feature_value_index">
                            ...
                            <div class="fn_row okay main_list_body_item fn_sort_item fn_new_value" style="display: none;">
                                <div class="main_list_row">
