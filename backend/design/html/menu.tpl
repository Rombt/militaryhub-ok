        ...
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="main_list products_list fn_sort_list fn_row" data-index="0">
                        {*Шапка таблицы*}
                        <div class="main_list_head">
                            <div class="main_list_heading main_list_drag"></div>
                            <div class="main_list_heading main_list_menu_name">
                                <span class="main_list_menu_item">{$btr->general_name|escape}</span>
                                <span class="main_list_menu_item quickview_hidden">{$btr->menu_general_url|escape}</span>
                            </div>
                            <div class="main_list_heading main_list_status">{$btr->general_enable|escape}</div>
                            <div class="main_list_heading main_list_status">{$btr->menu_general_target_blank|escape}</div>
                            <div class="main_list_heading main_list_menu_setting">{$btr->menu_general_add|escape}</div>
                            <div class="main_list_heading main_list_close"></div>
                        </div>
                        {assign var="index" value=1}
                        {function name=menu_items}
                            <div class="main_list_body categories_wrap sortable fn_sub_rows submenu_level_{$level}" data-level="{$level}">
                                {foreach $menu_items as $menu_item}
                                    <div class="fn_row main_list_body_item" data-index="{$index}">
                                        <div class="main_list_row fn_sort_item">
                                            ...
                                            <div class="main_list_boding main_list_menu_name">
                                                <span class="main_list_menu_item">
                                            ...
                                            <div class="main_list_boding main_list_menu_setting">
                        ...
                        <div class="fn_row fn_new_menuitem main_list_body_item" data-index="-1">
                            <div class="main_list_row fn_sort_item">
                            ...
                            <div class="main_list_body categories_wrap sortable fn_sub_rows" data-level="-1"></div>
                        </div>
