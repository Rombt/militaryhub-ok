        ...
        <form class="fn_form_list" method="post">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_coupon_name">{$btr->coupons_name|escape}</div>
                    <div class="main_list_heading main_list_coupon_sale">{$btr->general_discount|escape}</div>
                    <div class="main_list_heading main_list_coupon_condit">{$btr->general_conditions|escape}</div>
                    <div class="main_list_heading main_list_coupon_validity">{$btr->coupons_terms|escape}</div>
                    <div class="main_list_heading main_list_coupon_disposable">{$btr->coupons_one_off|escape}</div>
                    <div class="main_list_heading main_list_coupon_count">{$btr->coupons_qty_uses|escape}</div>
                    <div class="main_list_heading main_list_close"></div>
                </div>
                {*Блок добавления нового элемента*}
                <div class="main_list_body fn_new_coupon">
                    <div class="main_list_body_item">
                        <div class="main_list_row ">
                            <div class="main_list_heading main_list_check"></div>
                            <div class="main_list_boding main_list_coupon_name">
                            ...
                            <div class="main_list_boding main_list_coupon_sale">
                        ...
                        <div class="fn_row main_list_body_item">
                            <div class="main_list_row ">
                                <div class="main_list_boding main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="id_{$coupon->id}"></label>
                                </div>
                                <div class="main_list_boding main_list_coupon_name">
                                ...
                                <div class="main_list_boding main_list_coupon_count">
                                    {if $coupon->usages>0}
