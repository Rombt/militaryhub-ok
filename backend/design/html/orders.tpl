        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form class="fn_form_list" method="post">
                    ...
                    <div class="orders_list main_list products_list">
                        {*Шапка таблицы*}
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_order_number">№ </div>
                            <div class="main_list_heading main_list_orders_name">{$btr->general_full_name|escape}</div>
                            <div class="main_list_heading main_list_order_status">{$btr->general_status|escape}</div>
                            <div class="main_list_heading main_list_order_product_count">{$btr->general_products|escape}</div>
                            <div class="main_list_heading main_list_orders_price">{$btr->general_sales_amount}</div>
                            <div class="main_list_heading main_list_order_marker">{$btr->orders_label|escape}</div>
                            <div class="main_list_heading main_list_close"></div>
                        </div>
                        {*Параметры элемента*}
                        <div class="main_list_body">
                            {foreach $orders as $order}
                            <div class="fn_row main_list_body_item " style="border-left: 5px solid #{$order->status_color};">
                                <div class="main_list_row">
                                    <div class="main_list_boding main_list_check">
                                        ...
                                        <label class="main_ckeckbox" for="id_{$order->id}"></label>
                                    </div>

                                    <div class="main_list_boding main_list_order_number">
                                    ...
                                    <div class="main_list_boding main_list_orders_name">
                                    ...
                                    <div class="main_list_boding main_list_order_status">
                                        {$orders_status[$order->status_id]->name|escape}
                                    </div>

                                    <div class="main_list_boding main_list_order_product_count">
                                    ...
                                    <div class="main_list_boding main_list_orders_price">
                                        <div class="input-group">
                                    ...
                                    <div class="main_list_boding main_list_order_marker">
                        ...
                        <div class="main_list_footer">
                            <div class="main_list_foot_left">
                                ...
                                <div class="main_list_option fn_show_label" style="display: none">
                                ...
                                <div class="main_list_option fn_show_status" style="display: none;">
