                ...
                <form class="fn_form_list fn_fast_button" method="post">
                    ...
                    <div class="post_wrap main_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_blog_name">{$btr->blog_name|escape}</div>
                            <div class="main_list_heading main_list_blog_type">{$btr->blog_type|escape}</div>
                            <div class="main_list_heading main_list_status">{$btr->general_enable|escape}</div>
                            <div class="main_list_heading main_list_setting main_list_blog_setting">{$btr->general_activities|escape}</div>
                                ...
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row">
                                        ...
                                        <div class="main_list_boding main_list_check">
                                            ...
                                            <label class="main_ckeckbox" for="id_{$post->id}"></label>
                                        </div>
                                        ...
                                        <div class="main_list_boding main_list_blog_name">
                                        ...
                                        <div class="main_list_boding main_list_blog_type">
                                            {if $post->type_post == "blog"}
                                                <div class="tag tag-warning">{$btr->blog_articles|escape}</div>
                                                {else}
                                                <div class="tag tag-info">{$btr->blog_one_news|escape}</div>
                                        ...
                                        <div class="main_list_setting main_list_blog_setting">
                                            {*open*}
                                            ...
                                            {*featured*}
                                            <button data-hint="{$btr->general_best_article|escape}" type="button" class="setting_icon setting_icon_featured fn_ajax_action {if $post->featured}fn_active_class{/if} hint-bottom-middle-t-info-s-small-mobile  hint-anim" data-module="blog" data-action="featured" data-id="{$post->id}" >
