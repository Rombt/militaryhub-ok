        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_photo hidden-sm-down">{$btr->general_photo|escape}</div>
                        ...
                        <div class="fn_row main_list_body_item   fn_sort_item">
                            <div class="main_list_row ">
                                ...
                                <div class="main_list_boding main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="id_{$category->id}"></label>
                                </div>
                                ...
                                <div class=" main_list_setting">
                                    {*featured*}
                                    <button data-hint="{$btr->general_featured_category|escape}" type="button" class="setting_icon setting_icon_featured fn_ajax_action {if $category->featured}fn_active_class{/if} hint-bottom-middle-t-info-s-small-mobile  hint-anim" data-module="category" data-action="featured" data-id="{$category->id}" >
                                        {include file='svg_icon.tpl' svgId='icon_featured'}
                                    </button>

                                    {*rozetka feed*}
                                    <button data-hint="{$btr->category_rozetka_exclude|escape}" type="button" class="setting_icon setting_icon_exclude fn_ajax_action {if $category->rozetka_exclude}fn_active_class{/if} hint-bottom-middle-t-info-s-small-mobile  hint-anim" data-module="category" data-action="rozetka_exclude" data-id="{$category->id}" >
                                        R
                                    </button>
                    ...
                    <div class="main_list_foot_left">
                        ...
                        <div class="main_list_option">
                            <select name="action" class="selectpicker">
                                ...
                                <option value="in_rozetka_feed">{$btr->categories_rozetka_include|escape}</option>
                                <option value="out_rozetka_feed">{$btr->categories_rozetka_exclude|escape}</option>
