            ...
            <div class="boxed fn_toggle_wrap ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-1">
                            <textarea class="form-control main_textarea" name="accesses">{$accesses}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="main_list">
                                ...
                                <div class="main_list_head">
                                    <div class="main_list_heading main_list_topic_name">{$btr->general_name|escape}</div>
                                    <div class="main_list_heading main_list_topic_message">{$btr->topic_message|escape}</div>
                                    <div class="main_list_heading main_list_topic_time">{$btr->topic_spent_time|escape}</div>
                                </div>
                                {*Параметры элемента*}
                                <div class="main_list_body">
                                    ...
                                    <div class="fn_row main_list_body_item">
                                        <div class="main_list_row">
                                            <div class="main_list_boding main_list_topic_name">
                                            ...
                                            <div class="main_list_boding main_list_topic_message">
                                                {$comment->text}
                                            </div>

                                            <div class="main_list_boding main_list_topic_time {if $comment->spent_time < 0}text-success{/if}">
            ...
            <div class="boxed match fn_toggle_wrap tabs">
                ...
                <div class="toggle_body_wrap on fn_card row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="comment_text" id="fn_editor" class="form-control main_textarea editor_small">{$topic_message|nl2br}</textarea>
                    </div>
