...
class Okay
{
    ...
    private $classes = array(
        ...
        'googleTranslationApi' => 'GoogleCloudTranslationApi',
        /* GoogleCloudTranslationAPI */
    ...
    public function __construct()
    {
        ...
        if (
            $debug == true
            || isset($_COOKIE['1a4f6fc9192d077c7e91ada66df780ce'])
        ) {
        ...
        $dev_debug = $this->config->dev_debug_mode;
        if ($dev_debug == true && !empty($_SESSION['admin'])) {
            ini_set('display_errors', 'on');
            error_reporting(E_ALL);
        } else {
            ini_set('display_errors', 'off');
