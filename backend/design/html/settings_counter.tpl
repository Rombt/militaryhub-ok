                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-1">
                                                        <textarea name="counters[code][]" class="form-control main_textarea">{$c->code|escape}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="heading_label">{$btr->counters_counter_code|escape}</div>
                                        <div class="mb-1">
                                            <textarea name="counters[code][]" class="form-control main_textarea"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
