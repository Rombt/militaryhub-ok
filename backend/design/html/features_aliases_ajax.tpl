    ...
    <div class="fn_sort_list">
        ...
        <div class="main_list ok_related_list">
            <div class="main_list_head">
                ...
                <div class="main_list_heading feature_alias_name">{$btr->feature_feature_alias_name}</div>
                <div class="main_list_heading feature_alias_variable">{$btr->feature_feature_alias_variable}</div>
                <div class="main_list_heading feature_alias_value">{$btr->feature_feature_alias_value}</div>
                <div class="main_list_heading main_list_close"></div>
            </div>
            <div class="main_list_body fn_feature_aliases_list sortable">
                ...
                {foreach $features_aliases as $fa}
                    <div class="fn_row okay main_list_body_item fn_sort_item">
                        <div class="main_list_row">
                            ...
                            <div class="main_list_boding feature_alias_name">
                            ...
                            <div class="main_list_boding feature_alias_variable">
                            ...
                            <div class="main_list_boding feature_alias_value">
