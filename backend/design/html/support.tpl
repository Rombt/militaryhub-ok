        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form class="fn_form_list" method="post">
                    ...
                    <div class="orders_list main_list fn_sort_list">
                        {*Шапка таблицы*}
                        <div class="main_list_head">
                            <div class="main_list_heading main_list_support_num">{$btr->support_number|escape}</div>
                            <div class="main_list_heading main_list_support_name">{$btr->support_theme|escape}</div>
                            <div class="main_list_heading main_list_support_status">{$btr->support_status|escape}</div>
                            <div class="main_list_heading main_list_support_time">{$btr->support_time|escape}</div>
                        </div>
                        {*Параметры элемента*}
                            ...
                            {foreach $topics as $topic}
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row">
                                        <div class="main_list_boding main_list_support_num">
                                        ...
                                        <div class="main_list_boding main_list_support_name">
                                            <div class="mb-q">
                                        ...
                                        <div class="main_list_boding main_list_support_status ">
                                        ...
                                        <div class="main_list_boding main_list_support_time {if $topic->spent_time < 0}text_success{/if}">
