<form method="post" action="https://secure.wayforpay.com/pay" accept-charset="utf-8">
    ...
    <input type="hidden" name="deliveryList" value="{$deliveryList|escape}">
    {if $deliveryCity}
        <input type="hidden" name="deliveryCity" value="{$deliveryCity|escape}">
    {/if}
    {if $deliveryAddress}
        <input type="hidden" name="deliveryAddress" value="{$deliveryAddress|escape}">
    {/if}
    <input type="hidden" name="deliveryFirstName" value="{$deliveryFirstName|escape}">
    <input type="hidden" name="clientLastName" value="{$clientLastName|escape}">
    <input type="hidden" name="deliveryLastName" value="{$deliveryLastName|escape}">
    <input type="hidden" name="clientEmail" value="{$clientEmail|escape}">
    <input type="hidden" name="deliveryEmail" value="{$deliveryEmail|escape}">
    <input type="hidden" name="clientPhone" value="{$clientPhone|escape}">
    <input type="hidden" name="deliveryPhone" value="{$deliveryPhone|escape}">
    ...
    <input type="submit" class="button btn_black" value="{$lang->form_to_pay}">
</form>