                ...
                <div class="main_list">
                    <div class="currencies_wrap clearfix">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_currency_num">ID</div>
                            <div class="main_list_heading main_list_currency_name">{$btr->currency_name|escape}</div>
                            <div class="main_list_heading main_list_currency_sign">{$btr->currency_symbol|escape}</div>
                            <div class="main_list_heading main_list_currency_iso">{$btr->currency_iso|escape}</div>
                            <div class="main_list_heading main_list_currency_exchange">{$btr->currency_rate|escape}</div>
                            <div class="main_list_heading main_list_status hidden-md-down">{$btr->general_enable|escape}</div>
                            <div class="main_list_heading cur_settings">{$btr->general_activities|escape}</div>
                            <div class="main_list_heading main_list_close"></div>
                        </div>
                        {*Параметры элемента*}
                        <div id="currencies_block" class="main_list_body sortable">
                            {foreach $currencies as $c}
                                <div class="main_list_body_item">
                                    <div class="main_list_row">
                                        ...
                                        <div class="main_list_boding main_list_currency_num">
                                            <span>{$c->id}</span>
                                        </div>
                                        <div class="main_list_boding main_list_currency_name">
                                            ...
                                            <div class="hidden-md-up mt-q">
                                                <div class="main_list_currency_exchange_item">
                                                    {if !$c@first}
                                        ...
                                        {/if}
                                        <div class="main_list_boding main_list_status hidden-md-down">
                            ...
                            <div id="new_currency" class="main_list_body sortable" style="display: none">
                                <div class="main_list_body_item">
                                    <div class="main_list_row">
                                        <div class="main_list_boding main_list_drag move_zone">
                                            {include file='svg_icon.tpl' svgId='drag_vertical'}
                                        </div>
                                        <div class="main_list_boding main_list_currency_num"></div>
                                        <div class="main_list_boding main_list_currency_name">
                                        ...
                                        <div class="main_list_setting cur_settings"></div>
                                        <div class="main_list_boding main_list_close"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="action" class="main_list_footer">
                            <div class="main_list_foot_left"></div>
