            ...
            <form class="fn_form_list" method="post">
                ...
                <div class="main_list products_list fn_sort_list">
                    ...
                    <div class="main_list_head">
                        ...
                        <div class="main_list_heading main_list_features_name">{$btr->banners_group_name|escape}</div>
                        <div class="main_list_heading main_list_brands_tag">{$btr->banners_display|escape}</div>
                    ...
                    {*Параметры элемента*}
                    <div class="banners_groups_wrap main_list_body features_wrap sortable">
                        ...
                        <div class="fn_row main_list_body_item fn_sort_item">
                            <div class="main_list_row">
                                ...
                                <div class="main_list_boding main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="id_{$banner->id}"></label>
                                </div>
                                ...
                                <div class="main_list_boding main_list_brands_tag">
                                    <div class="wrap_tags">
