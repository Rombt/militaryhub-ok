...
class Managers extends Okay
{
    ...
    public $permissions_list = array('products', 'categories', 'brands', 'features', 'orders', 'order_settings',
        'users', 'groups', 'coupons', 'referrals', 'pages', 'blog', 'comments', 'feedbacks', 'import', 'export',
        'stats', 'design', 'settings', 'currency', 'delivery', 'payment', 'managers', 'license', 'languages',
        'banners', 'metachanges', 'seocomments', 'fastfilters', 'callbacks','robots', 'seo_patterns', 'support', 'subscribes', 'menu', 'seo_filter_patterns', 
