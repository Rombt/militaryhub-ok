        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form method="post" class="fn_form_list">
                    ...
                    <div class="managers_wrap main_list">
                        {*Шапка таблицы*}
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_manager_name">{$btr->general_name|escape}</div>
                                ...
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row">
                                        <div class="main_list_boding main_list_check">
                                            ...
                                            <label class="main_ckeckbox" for="id_{$manager_admin->id}"></label>
                                        </div>

                                        <div class="main_list_boding main_list_manager_name">
