...
class PaymentMethodAdmin extends Okay {
    ...
    public function fetch() {
        ...
        if($this->request->method('post')) {
            ...
            $payment_method->max_discount_value = $this->request->post('max_discount_value', 'float');
            ...
            $payment_method->advance_payment     = $this->request->post('advance_payment', 'intgeger');
            $payment_method->advance_payment_2     = $this->request->post('advance_payment_2', 'intgeger');
            $payment_method->advance_sum_delimiter     = $this->request->post('advance_sum_delimiter', 'intgeger');
