        ...
        <div class="col-lg-6 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    ...
                    <div class="">
                        <div class="heading_label">{$btr->banners_image_annotation|escape}</div>
                        <div class="">
                            <input name="annotation" class="form-control" value="{$banners_image->annotation|escape}" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="boxed match fn_toggle_wrap tabs">
                <div class="heading_tabs">
                    <div class="tab_navigation">
                        {* <a href="#tab1" class="tab_navigation_link">{$btr->banners_image_annotation|escape}</a> *}
                        <a href="#tab2" class="tab_navigation_link">{$btr->banners_image_description|escape}</a>
                    </div>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                ...
                <div class="toggle_body_wrap on fn_card ">
                    <div class="tab_container">
                        ...
                        <div id="tab2" class="tab">
                            <textarea name="description" class="editor_large fn_editor_class">{$banners_image->description|escape}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
