{* Title *}
{$meta_title = $btr->general_seocomments scope=parent}
    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                {$btr->general_seocomments|escape}
            </div>
            <div class="box_btn_heading">
                <a class="btn btn_small btn-info" href="{url module=SeoCommentAdmin}">
                    {include file='svg_icon.tpl' svgId='plus'}
                    <span>{$btr->seocomments_add|escape}</span>
                </a>
            </div>
        </div>
    </div>
...
<div class="boxed fn_toggle_wrap">
                ...
                <form id="list_form" method="post" class="fn_form_list fn_fast_button">
                    ...
                    <div class="pages_wrap main_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_page_name">{$btr->seocomments_name|escape}</div>
                        ...
                        <div id="sortable" class="main_list_body sortable">
                            {foreach $seo_comments as $seo_comment}
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row">
                                        <input type="hidden" name="positions[{$seo_comment->id}]" value="{$seo_comment->id}">
                                        ...
                                        <div class="main_list_boding main_list_check">
                                            <input class="hidden_check" type="checkbox" id="id_{$seo_comment->id}" name="check[]" value="{$seo_comment->id}"/>
                                            <label class="main_ckeckbox" for="id_{$seo_comment->id}"></label>
                                        </div>

                                        <div class="main_list_boding main_list_page_name">
                                            <a href="{url module=SeoCommentAdmin id=$seo_comment->id return=$smarty.server.REQUEST_URI}">
                                        ...
                                        <div class="main_list_setting main_list_pages_setting">
                                            {*open*}
                                            <a href="../{$lang_link}{$seo_comment->url|escape}" target="_blank" data-hint="{$btr->general_view|escape}" class="setting_icon setting_icon_open hint-bottom-middle-t-info-s-small-mobile  hint-anim">
                                        ...
                                        <div class="main_list_boding main_list_close">
                                            {*delete*}
                                            <button data-hint="{$btr->seocomments_delete|escape}" type="button" class="btn_close fn_remove hint-bottom-right-t-info-s-small-mobile  hint-anim" data-toggle="modal" data-target="#fn_action_modal" onclick="success_action($(this));">
    ...
    {else}
        <div class="heading_box mt-1">
            <div class="text_grey">{$btr->seocomments_no|escape}</div>
        </div>
    {/if}
</div>