...
class Integration1C
{
    ...
    public $full_update = false;     // Обновлять все данные при каждой синхронизации
    
    public $delete_all	= false;    // Очищать всю базу товаров при каждой выгрузке true:false PLEASE BE CAREFULL
    
    public $brand_option_name = 'Бренд'; // Название параметра товара, используемого как бренд
    ...
    public $static_categories_name = array('Мілітарі');
