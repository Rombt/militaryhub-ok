                ...
                <div class="row">
                    <div class="col-lg-12 toggle_body_wrap on fn_card">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group clearfix">
                                    <div class="heading_label">{$btr->payment_method_max_discount_value|escape}</div>
                                    <div class="">
                                        <input name="max_discount_value" class="form-control" type="text" value="{$payment_method->max_discount_value|escape}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group clearfix">
                                    <div class="heading_label" >{$btr->general_advance_payment|escape}</div>
                                    <div class="">
                                        <input name="advance_payment" class="form-control" type="number" min="0.00" step="0.01" value="{$payment_method->advance_payment|escape}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group clearfix">
                                    <div class="heading_label" >{$btr->general_advance_payment_2|escape}</div>
                                    <div class="">
                                        <input name="advance_payment_2" class="form-control" type="number" min="0.00" step="0.01" value="{$payment_method->advance_payment_2|escape}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group clearfix">
                                    <div class="heading_label" >{$btr->general_advance_sum_delimiter|escape}</div>
                                    <div class="">
                                        <input name="advance_sum_delimiter" class="form-control" type="number" min="0.00" step="0.01" value="{$payment_method->advance_sum_delimiter|escape}"/>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group clearfix">
                                                        <div class="boxes_inline">
                                                            ...
                                                            <label class="main_ckeckbox" for="{$setting->variable}"></label>
                                                        </div>
                       ...
                       {foreach $deliveries as $delivery}
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="payment_item">
                                    ...
                                    <label for="id_{$delivery->id}" class="main_ckeckbox {if in_array($delivery->id, $payment_deliveries)}active_payment{/if}">
