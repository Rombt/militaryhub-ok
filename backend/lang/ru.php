...
$backend_translations->banner_instruction2 = 'Для перелистывания баннеров вставьте следующий скрипт в файл js в шаблоне';
...
$backend_translations->banners_image_annotation = 'Короткое описание';
$backend_translations->banners_image_description = 'Полное описание';
...
$backend_translations->brand_rozetka_include = 'Добавить бренд к фиду Розетки';
$backend_translations->brand_rozetka_exclude = 'Убрать бренд из фиду Розетки';
$backend_translations->brand_rozetka_ban_check = 'Проверка бренда на бан розетки';
...
$backend_translations->brands_in_xml = 'Выгрузить товары бренда в фид';
$backend_translations->brands_no = 'Нет брендов';
$backend_translations->brands_out_xml = 'Не выгружать товары бренда в фид';
$backend_translations->brands_feed_for_rozetka = 'Выгружать в Rozetka';
...
$backend_translations->categories_in_xml = 'Выгрузить товары категории в фид';
$backend_translations->categories_no = 'Нет категорий';
$backend_translations->categories_out_xml = 'Не выгружать товары категории в фид';
$backend_translations->categories_products = 'Категории товаров';
$backend_translations->categories_rozetka_include = 'Добавить категории в фид Розетки';
$backend_translations->categories_rozetka_exclude = 'Убрать категории из фида Розетки';
...
$backend_translations->category_xml_name = 'Имя категории для фида';
$backend_translations->category_rozetka_exclude = 'Убрать категорию из фида Розетки';
$backend_translations->category_rozetka_feature_value_empty = 'Необходимо добавить свойство товара';
$backend_translations->category_rozetka_feature_value_link = 'Ссылка на свойство';
$backend_translations->category_rozetka_feature_value_right = 'Есть значение категории розетки';
$backend_translations->category_rozetka_feature_value_wrong = 'Необходимо добавить название категории розетки для свойства';
...
$backend_translations->reviews = 'Отзывы';
$backend_translations->comments_page = 'странице';
...
$backend_translations->feature_xml = 'В фид';
...
$backend_translations->general_add_xml = 'Добавить в фид';
$backend_translations->general_add_xml_short = 'В фид';
...
$backend_translations->general_mainorder = 'Фиксировать';
$backend_translations->general_best_article = 'Лучшая статья';
...
$backend_translations->general_from_xml_short = 'Из фид';
...
$backend_translations->general_not_in_xml_short = 'Не в фиде';
...
$backend_translations->general_promo_price = 'Промо цена';
...
$backend_translations->general_remove_xml = 'Убрать из фида';
...
$backend_translations->general_size = 'Размер';
...
$backend_translations->import_banlist_log_categories = 'Стоп лист категорий';
$backend_translations->import_banlist_log_brads = 'Стоп лист брендов';
...
$backend_translations->metachange_updated = 'Мета обновлен';
$backend_translations->metachange_add = 'Добавление мета';
$backend_translations->metachange_added = 'Мета добавлен';
$backend_translations->metachanges_name = 'URL';
$backend_translations->metachanges_add = 'Добавить мета на страницу';
$backend_translations->metachanges_delete = 'Удалить мета';
$backend_translations->metachanges_no = 'Нет мета страниц';

$backend_translations->seocomment_updated = 'Seo комментарий обновлен';
$backend_translations->seocomment_add = 'Добавление Seo комментария';
$backend_translations->seocomment_added = 'Seo комментарий добавлен';
$backend_translations->seocomments_name = 'URL';
$backend_translations->seocomments_add = 'Добавить seo комментарий в категорию';
$backend_translations->seocomments_delete = 'Удалить seo комментарий';
$backend_translations->seocomments_no = 'Нет seo комментариев';

$backend_translations->fastfilter_updated = 'Быстрофильтры обновлены';
$backend_translations->fastfilter_add = 'Добавление Быстрофильтра';
$backend_translations->fastfilter_added = 'Быстрофильтр добавлен';
$backend_translations->fastfilters_name = 'URL';
$backend_translations->fastfilters_add = 'Добавить Быстрофильтр в категорию';
$backend_translations->fastfilters_delete = 'Удалить Быстрофильтр';
$backend_translations->fastfilters_no = 'Нет Быстрофильтров';

$backend_translations->pages_other = 'Другие страницы';
$backend_translations->pages_site = 'Страницы сайта';
$backend_translations->general_metachanges = 'Мета теги';
$backend_translations->general_seocomments = 'Seo комментарии';
$backend_translations->general_fastfilters = 'Быстрофильтры';
...
$backend_translations->product_translete_done = 'Перевод выполнен';
$backend_translations->post_rating = 'Рейтинг статьи';
...
$backend_translations->products_no_discounted = 'Без скидки';
...
$backend_translations->products_in_of_stock = 'В наличии';
...
$backend_translations->reportstats_all_groups = 'Все группы';
...
$backend_translations->reportstats_only_users = 'Все зарегистрированные';
$backend_translations->reportstats_no_users = 'Не зарегистрированные';
$backend_translations->reportstats_buyers = 'Все покупатели';
$backend_translations->reportstats_referrals = 'Без реферала';
...
$backend_translations->settings_feed_descr = 'Выводить в фид краткое или полное описание товара(активно = полное)';
...
$backend_translations->settings_products_feed = 'Настройки фида товаров';
$backend_translations->settings_feed_rozetka_prom = 'Взаемосвязь фида Розетки и Прома';
$backend_translations->settings_feed_rozetka_prom_from = 'Чисто фид Прома для фида Розетки';
$backend_translations->settings_feed_rozetka_prom_equal = 'Добавить к фиду Розетки фид Прома';
$backend_translations->settings_feed_rozetka_prom_not = 'Не смешивать фид Розетки та Прому';
...
$backend_translations->translation_not_allowed = 'Переменная с именем определённым в api не допустима!';
...
$backend_translations->left_metachanges = 'Переопределение Мета тегов';
$backend_translations->left_seocomments = 'Seo комментарии';
$backend_translations->left_fastfilters = 'Быстрофильтры';
...
$backend_translations->left_setting_products_feed_title = 'Настройки фида товаров';
...
$backend_translations->import_banlist_log = 'Лог бан Розетки';
$backend_translations->import_banlist_log_categories = 'Лог бан списка категорий';
$backend_translations->import_banlist_log_brads = 'Лог бан списка брендов';
$backend_translations->import_blacklist_log_item_removed = 'Удалено из бан списку';
$backend_translations->import_blacklist_log_item_added = 'Добавлено к бан списку';
$backend_translations->import_banlist_log_no_logs = 'Нет записей в бан листе';
...
$backend_translations->import_info = 'При загрузке файла импорта система автоматически считывает все поля (колонки) из файла.
 ...
 <br>Кликнув по надписи в столбце "Поля системы" вы можете самостоятельно указать, чему будет соответствовать колонка из файла в системе';
...
$backend_translations->author_add = 'Имя автора статьи';
$backend_translations->views = 'Просмотров статьи';

/* turbosms */
$backend_translations->left_turbosms_title = 'Настройки TurboSMS';
$backend_translations->settings_turbosms = 'Настройки TurboSMS';
$backend_translations->settings_turbosms_keys = 'Ключи';
$backend_translations->settings_turbosms_login = 'Логин';
$backend_translations->settings_turbosms_pass = 'Пароль';
$backend_translations->settings_turbosms_settings = 'Настройки сообщений';
$backend_translations->settings_turbosms_order = 'Сообщение о новом заказе';
$backend_translations->settings_turbosms_register = 'Потверждение регистрации';
$backend_translations->settings_turbosms_birthday = 'Напоминание в День рождения';
$backend_translations->settings_turbosms_bonuses_removed = 'Напоминание о списании бонусов';
$backend_translations->settings_turbosms_enabled = 'Включено';
$backend_translations->settings_turbosms_sender = 'Подпись отправителя';
$backend_translations->settings_turbosms_test_mode = 'Тестовый режим';
$backend_translations->settings_turbosms_fields = 'Переменные';
/* turbosms */

/* esputnik */
$backend_translations->left_setting_esputnik_title = 'Настройки ESputnik';
$backend_translations->settings_esputnik = 'Настройки ESputnik';
$backend_translations->settings_esputnik_login = 'Данные авторизации';
$backend_translations->settings_esputnik_user = 'Логин';
$backend_translations->settings_esputnik_pass = 'Пароль';
$backend_translations->settings_esputnik_notify_reverce = 'Обратный адрес оповещений';
/* esputnik */

/* novaposhta */
$backend_translations->left_novaposhta = 'Настройки Новая Почта';
$backend_translations->left_novaposhta_title = 'Настройки Новая Почта';
$backend_translations->settings_novaposhta = 'Настройки Новая Почта';
$backend_translations->settings_novaposhta_keys = 'API Ключи';
$backend_translations->settings_novaposhta_token = 'Ключ';
$backend_translations->settings_novaposhta_sender = 'Настройки отправителя';
$backend_translations->settings_novaposhta_city = 'Город отправителя';
$backend_translations->settings_novaposhta_ware = 'Отделение отправителя';
$backend_translations->settings_novaposhta_settings = 'Настройки просчёта и отправки';
$backend_translations->settings_novaposhta_deliveryType = 'Тип доставки';
$backend_translations->settings_novaposhta_cargoType = 'Вид груза';
$backend_translations->settings_novaposhta_settings = 'Настройки просчёта и отправки';
$backend_translations->settings_novaposhta_TypeOfPayer = 'Виды плательщиков';
$backend_translations->settings_novaposhta_PaymentForm = 'Форма оплаты';
$backend_translations->settings_requisites_contragent = 'Тип контрагента для API';
$backend_translations->settings_novaposhta_api = 'Параметры API';
$backend_translations->settings_novaposhta_contragent_id = 'Ид контрагента';
$backend_translations->novaposhta_sender_update = 'Обновить настройки отправителя';
$backend_translations->novaposhta_WarehouseWarehouse = 'Склад-Склад';
$backend_translations->novaposhta_WarehouseDoors = 'Склад-Двери';
/* novaposhta */

/* justin */
$backend_translations->left_justin = 'Настройки Just In';
$backend_translations->left_justin_title = 'Настройки Just In';
$backend_translations->settings_justin = 'Настройки Just In';
$backend_translations->settings_justin_login = 'Данные авторизации';
$backend_translations->justin_login = 'Логин';
$backend_translations->justin_pass = 'Пароль';
$backend_translations->justin_api_key = 'API Ключ';
$backend_translations->settings_justin_sender = 'Настройки отправителя';
$backend_translations->settings_justin_city = 'Город отправителя';
$backend_translations->settings_justin_ware = 'Отделение отправителя';
/* justin */

/* autorize */
$backend_translations->left_autorize = 'Настройки авторизации';
$backend_translations->left_autorize_title = 'Настройки авторизации';
$backend_translations->settings_autorize = 'Настройки авторизации';
$backend_translations->settings_autorize_google = 'Google';
$backend_translations->settings_autorize_google_client_id = 'Client ID';
$backend_translations->settings_autorize_google_client_secret = 'Client Secret';
$backend_translations->settings_autorize_google_enabled = 'Активна';
$backend_translations->settings_autorize_google_test_mode = 'Тестовый режим';
$backend_translations->settings_autorize_facebook = 'Facebook';
$backend_translations->settings_autorize_facebook_app_id = 'Идентификатор приложения';
$backend_translations->settings_autorize_facebook_app_secret = 'Секрет приложения';
$backend_translations->settings_autorize_facebook_enabled = 'Активна';
$backend_translations->settings_autorize_facebook_test_mode = 'Тестовый режим';
/* autorize */

/* Настройки заказов  */
$backend_translations->settings_orders_orders = 'Настройки заказов';
$backend_translations->settings_orders_status_fast = 'Статус заказа в 1 клик';
$backend_translations->settings_orders_status_preorder = 'Статус предзаказа';
/* Настройки заказов  */

/* Картинка вариации */
$backend_translations->general_image_variant = 'Изображение';
$backend_translations->general_delete_image = 'Удалить картинку';
/* Картинка вариации */

/* Типы товаров */
$backend_translations->left_types_title = 'Типы товаров';
$backend_translations->products_types = 'Типы товаров';
$backend_translations->products_types_title = 'Типы товаров';
$backend_translations->products_type_add = 'Добавить тип товара';
$backend_translations->products_type_delete = 'Удалить тип товара';
$backend_translations->products_types_no = 'Нет типов товаров';
$backend_translations->products_type_new = 'Новый тип товара';
$backend_translations->products_type_add = 'Добавить тип товара';
$backend_translations->products_type_added = 'Тип товара добавлен';
$backend_translations->products_type_updated = 'Тип товара обновлён';
$backend_translations->products_type_exists = 'Такой тип товара существует';
$backend_translations->category_attach_brand_no = 'Категория не имеет размерной сетки';
$backend_translations->products_types_options = 'Типы товаров и размерные сетки';
$backend_translations->products_type_delete_image = 'Удалить только размерную сетку';
$backend_translations->products_type_delete_type = 'Удалить тип товара и размерную сетку';
$backend_translations->products_type_add_option = 'Добавить тип товара и размерную сетку';
/* Типы товаров */

/* Склады самовывоза */
$backend_translations->left_stores = 'Склады';
$backend_translations->left_stores_title = 'Склады самовывоза';
$backend_translations->general_stores = 'Склады';
$backend_translations->store_add = 'Добавить склад';
$backend_translations->store_new = 'Новый склад';
$backend_translations->general_stores = 'Склады';
$backend_translations->store_parameters = 'Параметры склада';
$backend_translations->store_address = 'Адрес';
$backend_translations->store_added = 'Склад добавлен';
$backend_translations->store_updated = 'Склад обновлён';
/* Склады самовывоза */

$backend_translations->category_attach_brand = 'Тип товара';
$backend_translations->category_attach_brand_url = 'Алиас размерной сетки';

$backend_translations->catalog_parent_menu_name = 'Наименование для меню';

/* referrals */
$backend_translations->left_referrals = 'Реферальные ссылки';
$backend_translations->left_referrals_title = 'Реферальные ссылки';
$backend_translations->referrals_referrals = 'Реферальные ссылки';
$backend_translations->referrals_add = 'Добавить реферальную ссылку';
$backend_translations->referrals_added = 'Реферальная ссылка добавлена';
$backend_translations->referrals_updated = 'Реферальная ссылка обновлена';
$backend_translations->referrals_exists = 'Реферальная ссылка существует';
$backend_translations->referrals_enter_code = 'Реферальная ссылка пустая';
$backend_translations->referrals_name = 'Наименование';
$backend_translations->referrals_code = 'Код';
$backend_translations->referrals_discount = 'Скидка';
$backend_translations->referrals_terms = 'Срок действия';
$backend_translations->referrals_one_off = 'Одноразовая';
$backend_translations->referrals_qty_uses = 'Кол-во переходов';
$backend_translations->referrals_enter_name = 'Введите наименование';
$backend_translations->referrals_enter_code = 'ведите ссылку';
$backend_translations->referrals_valid_until = 'Действует до';
$backend_translations->referrals_expired = 'Срок истёк';
$backend_translations->referrals_one_off = 'Одноразовая';
$backend_translations->referrals_many = 'Многоразовая';
$backend_translations->referrals_yes = 'Да';
$backend_translations->referrals_no = 'Нет';
$backend_translations->referrals_delete = 'Удалить реферальную ссылку';
$backend_translations->reportstats_paid = 'Оплаченные';
$backend_translations->reportstats_no_paid = 'Не оплаченные';
$backend_translations->general_copy = 'Копировать';

$backend_translations->referral_new = 'Новая реферальная ссылка';
$backend_translations->referral_add = 'Добавление реферальной ссылки';
/* referrals */

$backend_translations->left_apis = 'API';

$backend_translations->general_add_xml_rozetka = 'Rozetka';
$backend_translations->general_add_xml_epicentr = 'Епицентр';
$backend_translations->general_add_xml_prom = 'Prom.ua';
$backend_translations->general_add_xml_rss = 'RSS Google Feed';
$backend_translations->general_add_xml_short_rozetka = 'Включить для Rozetka';
$backend_translations->general_from_xml_short_rozetka = 'Выключить для Rozetka';
$backend_translations->general_add_xml_short_epicentr = 'Включить для Епицентр';
$backend_translations->general_from_xml_short_epicentr = 'Выключить для Епицентр';
$backend_translations->general_add_xml_short_prom = 'Включить для Prom.ua';
$backend_translations->general_from_xml_short_prom = 'Выключить для Prom.ua';
$backend_translations->general_add_xml_short_rss = 'Включить для RSS (Google Feed)';
$backend_translations->general_from_xml_short_rss = 'Выключить для RSS (Google Feed)';
$backend_translations->general_add_xml_rss_short = 'В RSS (Google Feed)';
$backend_translations->general_from_xml_rss_short = 'Из RSS (Google Feed)';
$backend_translations->products_general_set_mainorder = 'Установить Main Order';
$backend_translations->products_general_unset_mainorder = 'Удалить Main Order';

$backend_translations->settings_features = 'Настройки свойств';
$backend_translations->settings_features_size = 'Размер';
$backend_translations->settings_features_color = 'Цвет';
$backend_translations->settings_features_collection = 'Коллекция';
$backend_translations->settings_features_category_rozetka = 'Категория для Rozetka';
$backend_translations->settings_features_category_epicentrk = 'Категория для EpicentrK';
$backend_translations->general_rozetka_categories = 'Категории для Rozetka';
$backend_translations->general_epicentrk_categories = 'Категории для EpicentrK';
$backend_translations->category_rozetka_xml_name = 'Категория для Rozetka';
$backend_translations->category_epicentrk_xml_name = 'Категория для EpicentrK';
$backend_translations->category_general_epicentk_categories_xml_name = 'Категория для EpicentrK';
$backend_translations->left_rozetka_title = 'Категории для Rozetka';
$backend_translations->left_epicentrk_title = 'Категории для EpicentrK';
$backend_translations->rozetka_categories_message = 'Управление значениями свойства, которое указано в настройках каталога как категория для Rozetka, и выставление правильных ассоциаций';
$backend_translations->general_epicentk_categories_categories_message = 'Управление значениями свойства, которое указано в настройках каталога как категория для EpicentrK, и выставление правильных ассоциаций';

$backend_translations->settings_registration = 'Настройки регистрации';
$backend_translations->settings_registration_group = 'Группа пользователей при регистрации';
$backend_translations->settings_registration_promo_group = 'Група для реєстрації через Instagram (Insta_Promo)';

$backend_translations->callback_type_slow = 'Найдена меньшая цена';
$backend_translations->callback_type_default = 'Обратный звонок';

$backend_translations->settings_global_categories = "Настройка корневых разделов";
$backend_translations->settings_global_categories_clothes = "Одежда";
$backend_translations->settings_global_categories_appliances = "Техника";
$backend_translations->settings_global_category_no = "Не указан";
$backend_translations->category_epicentrk_xml_name = "Категория для EpicentrK";
$backend_translations->category_epicentrk_xml_enter = "Введите имя категории для EpicentrK";

$backend_translations->user_bonuses = "Бонуси";
$backend_translations->user_bonuses_add_delete = "Нарахування / списання бонусів";
$backend_translations->general_bonuses = "Зараховані бонуси";
$backend_translations->general_paid_bonuses = "Використані бонуси";
$backend_translations->general_bonuses_sign = "бонус(-ів)";
$backend_translations->user_bonuses_action_add_1 = 'Ми нараховуємо';
$backend_translations->user_bonuses_action_add_2 = 'бонус(-ів) для клієнта';
$backend_translations->user_bonuses_action_delete_1 = 'Ми списуємо';
$backend_translations->user_bonuses_action_delete_2 = 'бонус(-ів) для клієнта';
$backend_translations->user_bonuses_added = 'Користувач відредагований, бонуси успішно нараховано';
$backend_translations->user_bonuses_deleted = 'Користувач відредагований, бонуси успішно списано';
$backend_translations->settings_orders_first_bonuses = "Бонуси за перше замовлення";
$backend_translations->settings_birthday_bonuses = "Бонуси до Дня народження";
$backend_translations->settings_birthday_bonuses_on = "Зарахування бонусів до Дня народження";
$backend_translations->settings_birthday_bonuses_off = "Знищення бонусів від Дня народження";
$backend_translations->settings_birthday_bonuses_days = "днів";
$backend_translations->settings_users_bonuses_delete = 'Знищення бонусів';
$backend_translations->settings_users_bonuses_delete_notify = 'Сповіщення про видалення';
$backend_translations->general_birthday_date = "Дата народження";
$backend_translations->general_product_bonuses = "Бонуси";
$backend_translations->settings_max_bonuses_orders = 'Кількість для оплати замовлення';
$backend_translations->users_bonuses_added = 'Бонуси успішно нараховано';
$backend_translations->users_bonuses_deleted = 'Бонуси успішно списано';
$backend_translations->settings_catalog_bonuses = 'Настройки бонусов';

$backend_translations->settings_catalog_referrals = 'Настройки реферальных ссылок';
$backend_translations->settings_user_referral_value = 'Скидка новых реферальных ссылок';
$backend_translations->settings_user_referral_value_referrer = 'Скидка новых реферальных ссылок реферера';
$backend_translations->settings_user_referral_expire = 'Срок новых реферальных ссылок';
$backend_translations->settings_orders_labels_referral = 'Метка реферальных ссылки';
$backend_translations->orders_labels_referral_no = 'Не указана';
$backend_translations->users_bonuses = 'Бонусов';
$backend_translations->settings_products_bonuses = 'Бонусов по умолчанию';
...
$backend_translations->settings_novaposhta_update_confirm = 'Подтвердить принудительное обновление';
$backend_translations->settings_novaposhta_processed = 'Происходит обработка. Подождите...';
