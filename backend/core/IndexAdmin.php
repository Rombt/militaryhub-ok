...
class IndexAdmin extends Okay
{
    ...
    'left_banlist_log_title' => array( 'ImportBanlistLogAdmin' ),
    ),
    'left_stats' => array(
    ...
    'left_setting_products_feed_title' => array( 'SettingsProductsFeedAdmin' ),
    ...
    'SettingsProductsFeedAdmin' => 'settings',
    ...
    public function __construct()
    {
        ...
        //!!! ModulesCore 
        $this->addToLeftMenu(\ModulesCore\ModuleLoader::getMenu());        
        ...
        if (file_exists($file = 'backend/core/' . $module . '.php') ) {
            ...
            if (isset($rmbt_controller) ) {
                include_once $rmbt_controller;
            }
        }
                    
        //!! ModulesCore //!! 
        $this->addToBackendTranslations(\ModulesCore\ModuleLoader::getBackendTranslations());
    ...
    public function fetch()
    {
        ...
        if (get_class($this->module) == 'AuthAdmin' 
    ...
    protected function addToBackendTranslations( array $BackendTranslationsItems )
    {
        foreach ($BackendTranslationsItems as $key => $value) {
            $this->backend_translations->$key = $value;
        }
    }
