                ...
                <div class="toggle_body_wrap on fn_card">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="input-group mt-h mb-h">
                            <span class="boxes_inline heading_label">Модуль</span>
                            <span class="boxes_inline pg_id_grup">
                                <select name="method" class="selectpicker">
                                    <option value='' {if $delivery->method == ''}selected{/if}>Ручная обработка</option>
                                    <option value='novaposhta' {if $delivery->method == 'novaposhta'}selected{/if}>Новая Почта</option>
                                    <option value='justin' {if $delivery->method == 'justin'}selected{/if}>Just In</option>
                                    <option value='pickup' {if $delivery->method == 'pickup'}selected{/if}>Самовывоз</option>
                                </select>
                            </span>
                        </div>
                    </div>
                        ...
                        {foreach $payment_methods as $payment_method}
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="payment_item">
                                    ...
                                    <label for="id_{$payment_method->id}" class="main_ckeckbox {if in_array($payment_method->id, $delivery_payments)}active_payment{/if}">
