            ...
            <form class="fn_form_list" method="post">
                ...
                <div class="post_wrap main_list">
                    ...
                    <div class="main_list_head">
                        ...
                        <div class="main_list_heading main_list_comments_name">{$btr->general_comments|escape}</div>
                                ...
                                <div class="fn_row main_list_body_item {if $level > 0}admin_note2{/if}">
                                    <div class="main_list_row">
                                        ...
                                        <div class="main_list_boding main_list_check">
                                            ...
                                            <label class="main_ckeckbox" for="id_{$comment->id}"></label>
                                        </div>
                                            ...
                                            <div class="">
                                                ...
                                                {if $level == 0}
                                                    ...
                                                    {elseif $comment->type == "page"}
                                                        {$btr->comments_page|escape} <a href="../reviews" target="_blank">{$btr->reviews|escape}</a>
                                                    {/if}
                                                {/if}
                                            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal " method="post">
                    ...
                    <div class="form-group">
                        <textarea id="fn_comment_area" class="form-control main_textarea" placeholder="{$btr->general_enter_answer|escape}" name="text" rows="10" cols="50"></textarea>
                    </div>
