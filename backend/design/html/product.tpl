        ...
        <div class="wrap_heading">
            ...
            {if $product->id && !empty($product->url)}
                <div class="box_btn_heading">
                    <a class="btn btn_small btn-info add" target="_blank"
                       href="../{$lang_link}products/{$product->url}">
                            ...
                            <div class="col-xs-12 col-lg-6 col-md-10">
                                <div class="">
                                    <div class="input-group">
                                        ...
                                        <input name="url"
                                               class="fn_meta_field form-control fn_url {if $product->id}fn_disabled{/if}"
                                               {if $product->id}readonly=""{/if} type="text"
                                               value="{$product->url|escape}"/>
                                        <input type="checkbox" id="block_translit" class="hidden" value="1"
                                               {if $product->id}checked=""{/if}>
                        ...
                        <div class="activity_of_switch">
                                ...
                                <div class="main_switch clearfix">
                                    ...
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="visible" value='1' type="checkbox"
                                               id="visible_checkbox" {if $product->visible}checked=""{/if}/>
                            ...
                            <div class="activity_of_switch_item"> {* row block *}
                                <div class="main_switch clearfix">
                                    ...
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="featured" value="1" type="checkbox"
                            ...
                            <div class="activity_of_switch_item"> {* row block *}
                                <div class="main_switch clearfix">
                                    <label class="switch_label">{$btr->general_mainorder|escape}</label>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="main_order" value="1" type="checkbox"
                                               id="main_order_checkbox" {if $product->main_order}checked=""{/if}/>
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                </div>
                            ...
                            <div class="activity_of_switch_item"> {* row block *}
                                <div class="main_switch clearfix">
                                    <label class="switch_label">{$btr->product_translete_done|escape}</label>
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="automatic_translation_done" value="1"
                                               type="checkbox"
                                               {if $product->automatic_translation_done}checked=""{/if}/>
                                        <span class="switch-label"></span>
                                        <span class="switch-handle"></span>
                                    </label>
                                </div>
            ...
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="row">
                    <div class="col-lg-12 toggle_body_wrap on fn_card">
                        <div class="row">
                            <div class="col-xs-12">
                                <select name="brand_id" class="selectpicker mb-1{if !$brands} hidden{/if} fn_meta_brand"
                                        data-live-search="true">
                                    <option value="0" {if !$product->brand_id}selected=""{/if}
                                            data-brand_name="">{$btr->general_not_set|escape}</option>
                                    {foreach $brands as $brand}
                                        <option value="{$brand->id}" {if $product->brand_id == $brand->id}selected=""{/if}
                                                data-brand_name="{$brand->name|escape}">{$brand->name|escape}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div id="product_cats">
                                    ...
                                    <select class="selectpicker  mb-1 fn_product_category fn_meta_categories"
                                            data-live-search="true">
                                        <option value="0" selected="" disabled=""
                                                data-category_name="">{$btr->product_select_category}</option>
                                        {function name=category_select level=0}
                                            {foreach $categories as $category}
                                                <option value="{$category->id}"
                                                        {if $category->id == $first_category->id}selected{/if}
                                                        data-category_name="{$category->name|escape}">{section sp $level}- {/section}{$category->name|escape}</option>
                                    ...
                                    <div id="sortable_cat" class="fn_product_categories_list">
                                        {foreach $product_categories as $product_category}
                                            <div class="fn_category_item product_category_item {if $product_category@first}first_category{/if}">
                                                ...
                                                <label class="fn_delete_product_cat fa fa-times"
                                                    for="id_{$product_category->id}"></label>
                                                <input id="id_{$product_category->id}" type="checkbox"
                                                    value="{$product_category->id}"
                                                    data-cat_name="{$product_category->name|escape}" checked=""
                                                    name="categories[]">
                                            </div>
                                        {/foreach}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="heading_label">{$btr->general_product_bonuses|escape}</div>
                                <div class="input-group">
                                    <input class="form-control" name="bonuses" type="number" min="0" step="0.01" value="{$product->bonuses|number_format:2:'.':''}" />
        ...
        <div class="col-lg-12 col-md-12 ">
            <div class="boxed fn_toggle_wrap match_matchHeight_true">
                ...
                <div class="variants_wrapper fn_card">
                    <div class="main_list variants_list scrollbar-variant">
                        <div class="main_list_body sortable variants_listadd">
                            {foreach $product_variants as $variant}
                                <div class="main_list_body_item variants_list_item ">
                                    <div class="main_list_row">
                                        <div class="main_list_boding variants_item_drag">
                                            <div class="heading_label"></div>
                                            <div class="move_zone">
                                                {include file='svg_icon.tpl' svgId='drag_vertical'}
                                            </div>
                                        </div>
                                        <div class="main_list_boding variants_item_sku">
                                            <div class="heading_label">{$btr->general_sku|escape}</div>
                                            <input class="variant_input" name="variants[sku][]" type="text"
                                                   value="{$variant->sku|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_name">
                                            <div class="heading_label">{$btr->general_option_name|escape}</div>
                                            <input name="variants[id][]" type="hidden" value="{$variant->id|escape}"/>
                                            <input class="variant_input" name="variants[name][]" type="text"
                                                   value="{$variant->name|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_price">
                                            <div class="heading_label">{$btr->general_price|escape}</div>
                                            <input class="variant_input" name="variants[price][]" type="text"
                                                   value="{$variant->price|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_discount">
                                            <div class="heading_label">{$btr->general_old_price|escape}</div>
                                            <input class="variant_input" name="variants[compare_price][]" type="text"
                                                   value="{$variant->compare_price|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_discount">
                                            <div class="heading_label">{$btr->general_promo_price|escape}</div>
                                            <input class="variant_input" name="variants[promo_price][]" type="text"
                                                   value="{$variant->promo_price|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_currency">
                                            <div class="heading_label">{$btr->general_currency|escape}</div>
                                            <select name="variants[currency_id][]" class="selectpicker">
                                                {foreach $currencies as $c}
                                                    <option value="{$c->id}"
                                                            {if $c->id == $variant->currency_id}selected=""{/if}>{$c->code|escape}</option>
                                                {/foreach}
                                            </select>
                                        </div>
                                        <div class="main_list_boding variants_item_amount">
                                            <div class="heading_label">{$btr->general_qty|escape}</div>
                                            <input class="variant_input" name="variants[stock][]" type="text"
                                                   value="{if $variant->infinity || $variant->stock == ''}∞{else}{$variant->stock|escape}{/if}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_units">
                                            <div class="heading_label">{$btr->products_variant_units|escape}</div>
                                            <input class="variant_input" name="variants[units][]" type="text"
                                                   value="{$variant->units|escape}"/>
                                        </div>
                                    </div>
                                    <div class="main_list_row">
                                        <div class="main_list_boding variants_item_drag"></div>
                                        <div class="main_list_boding variants_item_weight">
                                            <div class="heading_label">{$btr->general_weight|escape}</div>
                                            <input class="variant_input" name="variants[weight][]" type="text"
                                                   value="{$variant->weight|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_size">
                                            <div class="heading_label">{$btr->general_size|escape}</div>
                                            <input class="variant_input" name="variants[size][]" type="text"
                                                   value="{$variant->size|escape}"/>
                                        </div>
                                        <div class="main_list_boding variants_item_color">
                                            <div class="heading_label">{$btr->general_color|escape}</div>
                                            <input class="variant_input" name="variants[color][]" type="text"
                                                   value="{$variant->color|escape}"/>
                                        </div>
                                    </div>
                                    <div class="main_list_row">
                                        <div class="main_list_boding variants_item_drag"></div>
                                        <div class="col-lg-8 col-md-12 pr-0">
                                            <div class="toggle_body_wrap fn_card on">
                                                <div class="fn_droplist_wrap product_images_list clearfix sortable"
                                                     data-image="variant" data-variant="{$variant->id}">
                                                    {if $variant@iteration > 1}
                                                        <div class="fn_dropzone dropzone_block">
                                                            <i class="fa fa-plus font-5xl" aria-hidden="true"></i>
                                                            <input type="file"
                                                                   name="dropped_variant_images[{$variant->id}][]"
                                                                   multiple class="dropinput">
                                                        </div>
                                                    {else}
                                                        <div>Изображения данной вариации следует загружать в верхний
                                                            блок!
                                                        </div>
                                                    {/if}
                                                    {if !empty($variant->images) || $variant@iteration > 1}
                                                        {foreach $variant->images as $image}
                                                            <div class="product_image_item{if $image@first} first_image{/if} fn_sort_item">
                                                                <button type="button"
                                                                        class="fn_remove_image remove_image"></button>
                                                                <i class="move_zone">
                                                                    <img class="product_icon"
                                                                         src='{$image->filename|resize:70:70:false:$config->resized_variants_dir}'/>
                                                                    <input type="hidden" name="variants_images[]"
                                                                           value="{$image->id}"/>
                                                                </i>
                                                            </div>
                                                        {/foreach}
                                                    {/if}
                                                    {if $variant@iteration > 1}
                                                        <div class="fn_new_variant_image_item product_image_item fn_sort_item">
                                                            <button type="button"
                                                                    class="fn_remove_image remove_image"></button>
                                                            <img src="" alt=""/>
                                                            <input type="hidden"
                                                                   name="variant_images_urls[{$variant->id}][]"
                                                                   value=""/>
                                                        </div>
                                                    {/if}
                                                </div>
                                        ...
                                        {* <div class="main_list_boding variants_item_yandex">
                                            <div class="main_switch clearfix">
                                        ...
                                        {* <div class="main_list_boding variants_item_file fn_file_wrap">
                                        ...
                                        {* <div class="main_list_boding variants_item_file fn_file_wrap">
                                            <div class="heading_label">{$btr->general_image_variant|escape}</div>
                                            {if $variant->image}
                                                <img class="product_icon" src='{$variant->image|resize:40:40}'>
                                            {else}
                                                <img class="product_icon" src="design/images/no_image.png" width="40">
                                            {/if}
                                            <input type="file" name="variant_image[]" />
                                            <input type="hidden" name="delete_variant_image[]" />
                                            {if $variant->image}
                                                <button data-hint="{$btr->general_delete_image|escape}" type="button" class="btn_close delete_grey fn_remove_variant_image hint-top-middle-t-info-s-small-mobile  hint-anim">
                                                    {include file='svg_icon.tpl' svgId='delete'}
                                                </button>
                                            {/if}
                                        </div> *}
                                        {if !$variant@first}
                                            <div class="main_list_boding main_list_close remove_variant">
                                                <button data-hint="{$btr->general_delete_product|escape}" type="button"
                                                        class="btn_close fn_remove_variant hint-bottom-right-t-info-s-small-mobile  hint-anim">
                                                    {include file='svg_icon.tpl' svgId='delete'}
                                                </button>
                                            </div>
                                        {/if}
                            ...
                            {* <div class="fn_new_variant_image_item product_image_item fn_sort_item">
                                <img src="" alt="" />
                                <input type="hidden" name='variant_images_urls[]' value="" />
                            </div> *}
                            <div class="main_list_body_item variants_list_item fn_new_row_variant">
                                <div class="main_list_row">
                                    <div class="main_list_boding variants_item_drag">
                                        <div class="heading_label"></div>
                                        <div class="move_zone">
                                ...
                                <div class="main_list_row">
                                    ...
                                    <div class="main_list_boding variants_item_color">
                                        <div class="heading_label">{$btr->general_color|escape}</div>
                                        <input class="variant_input" name="variants[color][]" type="text" value=""/>
                                    </div>
                                    <div class="main_list_boding variants_item_size">
                                        <div class="heading_label">{$btr->general_size|escape}</div>
                                        <input class="variant_input" name="variants[size][]" type="text" value=""/>
                                    </div>
                                </div>
                                {* <div class="main_list_row">
                                    <div class="main_list_boding variants_item_drag"></div>
                                    <div class="main_list_boding variants_item_file">
                                        <div class="heading_label">{$btr->general_digital_product|escape}</div>
                                        <input type="file" name="attachment[]" />
                                        <input type="hidden" name="delete_attachment[]" />
                                ...
                                {* <div class="main_list_row">
                                    ...
                                    <div class="main_list_boding main_list_close remove_variant_image">
                                        <button data-hint="{$btr->general_delete_image|escape}" type="button" class="btn_close delete_grey fn_remove_variant_image hint-top-middle-t-info-s-small-mobile  hint-anim">
                                            {include file='svg_icon.tpl' svgId='delete'}
                                        </button>
                                     </div>
                        ...
                        {if $special_images|count > 0}
                            {foreach $special_images as $special}
                                <li class="product_image_item {if $special@iteration > 4}fn_toggle_hidden hidden{/if} fn_sort_item {if $product->special == $special->filename}product_special{/if}">
                                    <button type="button" class=" fn_remove_image remove_image"></button>
                                    <i class="move_zone">
                                        <img class="product_icon" title="{$special->name}"
                                             src="../{$config->special_images_dir}{$special->filename}"
                                             alt="{$special->filename}"/>
                                        <span class="fn_change_special change_special"
                                              data-origin="{$btr->general_select|escape}"
                                              data-result="{$btr->general_unselect|escape}">
                                        ...
                                        <input type="radio" name="special" value="{$special->filename|escape}"
                                               class="hidden" {if $product->special == $special->filename}checked{/if}>
                                    </i>
            ...
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    ...
                    <div class="raiting_boxed">
                        ...
                        <input class="fn_rating range_input" type="range" min="1" max="5" step="0.1"
                    ...
                    <div class="features_wrap fn_features_wrap">
                                ...
                                {foreach $features_values.$feature_id as $feature_value}
                                    <div class="feature_row clearfix">
                                        <div class="feature_name{if !$feature_value@first} additional_values{/if}">
                                            {if $feature_value@first}
                                                ...
                                                <a href="index.php?module=FeatureAdmin&id={$feature->id}"
                                                   target="_blank">
                                                    {$feature->name|escape}
                                                </a>
                                            </span>
                                        ...
                                        <div class="feature_value">
                                            <input class="feature_input fn_auto_option" data-id="{$feature_id}"
                                                   type="text" name="features_values_text[{$feature_id}][]"
                                                   value="{$feature_value->value|escape}"{if $lang_id != $main_lang_id} readonly{/if}/>
                                            <input class="fn_value_id_input" type="hidden"
                                                   name="features_values[{$feature_id}][]"
                                                   value="{$feature_value->id}"/>
                                            <button type="button"
                                                    class="btn btn_mini{if $feature_value@first} btn-info fn_add{else} btn-danger fn_remove{/if} fn_feature_multi_values feature_multi_values">
                                            <span class="fn_plus" {if !$feature_value@first}style="display: none;"{/if}>
                                                {include file='svg_icon.tpl' svgId='plus'}
                                            </span>
                                                <span class="fn_minus"
                                                      {if $feature_value@first}style="display: none;"{/if}>
                                    ...
                                    <div class="feature_row clearfix">
                                        ...
                                        <div class="feature_value">
                                            <input class="feature_input fn_auto_option" data-id="{$feature_id}"
                                                   type="text" name="features_values_text[{$feature_id}][]"
                                                   value=""{if $lang_id != $main_lang_id} readonly{/if}/>
                                            <input class="fn_value_id_input" type="hidden"
                                                   name="features_values[{$feature_id}][]" value=""/>
                                            <button type="button"
                                                    class="btn btn_mini btn-info fn_add fn_feature_multi_values feature_multi_values">
                                            <span class="fn_plus">
                                                {include file='svg_icon.tpl' svgId='plus'}
                                            </span>
                        ...
                        <div class="fn_new_feature">
                            <div class="new_feature_row clearfix">
                                <div class="wrap_inner_new_feature">
                                    <input type="text" class="new_feature new_feature_name" name="new_features_names[]"
                                           placeholder="{$btr->product_features_enter|escape}"/>
                                    <input type="text" class="new_feature new_feature_value"
                                           name="new_features_values[]"
                                           placeholder="{$btr->product_features_value_enter|escape}"/>
                                </div>
                        ...
                        <div class="fn_new_feature_category">
                            <div class="feature_row clearfix">
                                ...
                                <div class="feature_value">
                                    <input class="feature_input fn_auto_option" data-id="" type="text" name=""
                                           value=""{if $lang_id != $main_lang_id} readonly{/if}/>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_210px">
                ...
                <div class="toggle_body_wrap on fn_card fn_sort_list">
                    <div class="main_list ok_related_list">
                        <div class="main_list_body related_products sortable">
                            {foreach $related_products as $related_product}
                                <div class="fn_row okay main_list_body_item fn_sort_item">
                                    <div class="main_list_row">
                                        <div class="main_list_boding main_list_drag move_zone">
                                            {include file='svg_icon.tpl' svgId='drag_vertical'}
                                        </div>
                                        <div class="main_list_boding main_list_related_photo">
                                            ...
                                            <a href="{url module=ProductAdmin id=$related_product->id}">
                                                {if $related_product->images[0]}
                                                    <img class="product_icon"
                                                         src='{$related_product->images[0]->filename|resize:40:40}'>
                                                {else}
                                                    <img class="product_icon" src="design/images/no_image.png"
                                                         width="40">
                                                {/if}
                                            </a>
                                        </div>
                                        <div class="main_list_boding main_list_related_name">
                                            <a class="link"
                                               href="{url module=ProductAdmin id=$related_product->id}">{$related_product->name|escape}</a>
                                        </div>
                                        <div class="main_list_boding main_list_close">
                                            <button data-hint="{$btr->general_delete_product|escape}" type="button"
                                                    class="btn_close fn_remove_item hint-bottom-right-t-info-s-small-mobile  hint-anim">
                                                {include file='svg_icon.tpl' svgId='delete'}
                                            </button>
                                        </div>
                                    </div>
                            ...
                            {/foreach}
                            <div id="new_related_product" class="fn_row okay main_list_body_item fn_sort_item"
                                 style='display:none;'>
                                <div class="main_list_row">
                                    <div class="main_list_boding main_list_drag move_zone">
                                        {include file='svg_icon.tpl' svgId='drag_vertical'}
                    ...
                    <div class="autocomplete_arrow">
                        <input type=text name=related id="related_products" class="form-control"
                               placeholder='{$btr->general_add_product|escape}'>
                    </div>
                </div>
            </div>
            ...
            <div class="boxed match fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <input name="meta_title" class="form-control fn_meta_field mb-h" type="text"
                               value="{$product->meta_title|escape}"/>
                        <div class="heading_label">Meta-keywords</div>
                        <input name="meta_keywords" class="form-control fn_meta_field mb-h" type="text"
                               value="{$product->meta_keywords|escape}"/>
                    </div>

                    <div class="col-lg-6 col-md-6 pl-0">
                        <div class="heading_label">Meta-description <span id="fn_meta_description_counter"></span></div>
                        <textarea name="meta_description"
                                  class="form-control main_textarea fn_meta_field">{$product->meta_description|escape}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="boxed match fn_toggle_wrap tabs">
                <div class="heading_tabs">
                    <div class="tab_navigation">
                        <a href="#tab1"
                           class="heading_box tab_navigation_link">{$btr->general_short_description|escape}</a>
                        <a href="#tab2"
                           class="heading_box tab_navigation_link">{$btr->general_full_description|escape}</a>
                    </div>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                        <a class="btn-minimize" href="javascript:;"><i class="icon-arrow-down"></i></a>
                    </div>
                    ...
                    <div class="tab_container">
                        <div id="tab1" class="tab">
                            <textarea name="annotation" id="annotation"
                                      class="editor_small">{$product->annotation|escape}</textarea>
                        </div>
                        <div id="tab2" class="tab">
                            <textarea id="fn_editor" name="description"
                                      class="editor_large fn_editor_class">{$product->description|escape}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<script>
    $(window).on("load", function () {
        ...
        var new_image_variant_clone = $(".fn_new_variant_image_item").first().clone(true);
        $(".fn_new_variant_image_item").remove();
        // Или перетаскиванием
                ...
                for (var i = 0, f; f = files[i]; i++) {
                    ...
                    reader.onload = (function (theFile) {
                        return function (e) {
                            ...
                            } else if (parent.data('image') == "variant") {
                                var clone_item = new_image_variant_clone.clone(true);
                                var variant_item = parent.data('variant');
                                clone_item.find("input[name*=variant_images_urls]").attr('name', 'variant_images_urls[' + variant_item + '][]');
                            }
        ...
        // Удалить изображение к варианту
        $(document).on("click", ".fn_remove_variant_image", function () {
            closest = $(this).closest(".fn_file_wrap");
            closest.find(".fn_attachment_name").hide("slow");
            $(this).hide("slow");
            closest.find("input[name*=delete_variant_image]").val("1");
            return false;
        });
        ...
        variant.find('.bootstrap-select').replaceWith(function () {
            return $('select', this);
        });
