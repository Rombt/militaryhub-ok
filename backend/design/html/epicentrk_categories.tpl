{* Title *}
{$meta_title=$btr->general_epicentrk_categories scope=parent}
    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                {$btr->general_epicentrk_categories|escape}
            </div>
        </div>
    </div>
</div>
        ...
        <form method="post" class="fn_form_list fn_fast_button">
            ...
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_categories_name">{$btr->category_epicentrk_xml_name|escape}</div>
                    ...
                    {foreach $features_values as $category}
                        <div class="fn_row main_list_body_item fn_sort_item">
                            <div class="main_list_row">
                                ...
                                <div class="main_list_boding main_list_categories_name">
                                    <div class="input-group epicentrk_list">
                                        <input type="text" class="input_autocomplete epicentrk form-control fn_url{if $category->epicentrk_name} fn_disabled{/if}" {if $category->epicentrk_name} readonly{/if} name="categories[epicentrk_name][{$category->id}]" value="{$category->epicentrk_name|escape}" placeholder="{$btr->category_select|escape}"/>
                                        <span class="input-group-addon fn_disable_url">
                                            {if $category->epicentrk_name}
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="boxed boxed_attention">
            <div class="">
               {$btr->epicentrk_categories_message|escape}
            </div>
        </div>
    </div>
</div>
...
<script>
$(function() {
    $('.input_autocomplete.epicentrk').devbridgeAutocomplete({
        serviceUrl:'ajax/market.php?module=search_epicentrk&session_id={/literal}{$smarty.session.id}{literal}',
        minChars:1,
        noCache: false,
        onSelect:
            function(suggestions) {
                $(this).closest('div').find('input[name*="epicentrk_name"]').val(suggestions.data.name);
            }
    });
