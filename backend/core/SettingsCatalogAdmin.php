...
public function fetch()
{
    ...
    if ($this->request->method('POST')) {
        ...
        if ($this->request->post('bonuses_without_discount_only', 'integer')) {
            $this->settings->bonuses_without_discount_only = $this->request->post('bonuses_without_discount_only', 'integer');
        } else {
            $this->settings->bonuses_without_discount_only = 0;
        }
