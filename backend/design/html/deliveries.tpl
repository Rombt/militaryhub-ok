        ...
        <form class="fn_form_list" method="post">
            <div class="main_list products_list fn_sort_list">
                ...
                <div class="main_list_head">
                    ...
                    <div class="main_list_heading main_list_delivery_photo">{$btr->general_image|escape}</div>
                    <div class="main_list_heading main_list_delivery_name">{$btr->general_name|escape}</div>
                    <div class="main_list_heading main_list_delivery_condit">{$btr->general_conditions|escape}</div>
                            ...
                            <div class="main_list_row">
                               <input type="hidden" name="positions[{$delivery->id}]" value="{$delivery->position}">
                                ...
                                <div class="main_list_boding main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="id_{$delivery->id}"></label>
                                </div>

                                <div class="main_list_boding main_list_delivery_photo">
                                    {if $delivery->image}
                                ...
                                <div class="main_list_boding main_list_delivery_condit">
                                    {if $delivery->separate_payment}
                                        <div><span class="tag tag-primary">{$btr->general_paid_separately|escape}</span></div>
                                    {/if}
                                    {if $delivery->price > 0}
