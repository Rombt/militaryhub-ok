                ...
                <form class="fn_form_list" method="post">
                    ...
                    <div class="main_list">
                        ...
                        <div class="main_list_head">
                            ...
                            <div class="main_list_heading main_list_order_stg_sts_name">{$btr->general_name|escape}</div>
                            <div class="main_list_heading main_list_order_stg_sts_status">{$btr->general_activities|escape}</div>
                            <div class="main_list_heading main_list_order_stg_sts_status">{$btr->order_settings_1c_action|escape}</div>
                            <div class="main_list_heading main_list_order_stg_sts_label">{$btr->order_settings_colour|escape}</div>
                            <div class="main_list_heading main_list_close"></div>
                        </div>
                        <div class="fn_status_list fn_sort_list main_list_body sortable">
                            {if $orders_status}
                                    ...
                                    <div class="fn_row main_list_body_item">
                                        <div class="main_list_row fn_sort_item">
                                            ...
                                            <div class="main_list_boding main_list_check">
                                                ...
                                                <label class="main_ckeckbox" for="id_or_{$order_status->id}"></label>
                                            </div>

                                            <div class="main_list_boding main_list_order_stg_sts_name">
                                            ...
                                            {if $is_mobile == false}
                                            <div class="main_list_boding main_list_order_stg_sts_status">
                                                <select name="is_close[{$order_status->id}]" class="selectpicker col-xs-12 px-0">
                                                    <option value="1" {if $order_status->is_close == 1}selected=""{/if} >{$btr->order_settings_reduse_products|escape}</option>
                                                    <option value="0" {if $order_status->is_close == 0}selected=""{/if} >{$btr->order_settings_not_reduse_products|escape}</option>
                                                </select>
                                            ...
                                            {/if}
                                            <div class="main_list_boding main_list_order_stg_sts_label">
                            ...
                            <div class="fn_row fn_new_status fn_sort_item main_list_body">
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row fn_sort_item">
                                        <div class="main_list_boding main_list_drag"></div>
                    ...
                    <div class="main_list">
                        ...
                        <div class="main_list_head">
                            <div class="main_list_heading main_list_check">
                                ...
                                <label class="main_ckeckbox" for="check_all_3"></label>
                            </div>
                            <div class="main_list_heading main_list_order_stg_lbl_name">{$btr->general_name|escape}</div>
                            <div class="main_list_heading main_list_order_stg_sts_label">{$btr->order_settings_colour|escape}</div>
                            <div class="main_list_heading main_list_close"></div>
                        </div>
                        <div class="fn_labels_list main_list_body sortable fn_sort_list">
                            ...
                            {foreach $labels as $label}
                                <div class="fn_row main_list_body_item">
                                    <div class="main_list_row fn_sort_item">
                                        ...
                                        <div class="cmain_list_boding main_list_check">
                                            <input class="hidden_check" type="checkbox" id="id_{$label->id}" name="check[]" value="{$label->id}"/>
                                            <label class="main_ckeckbox" for="id_{$label->id}"></label>
                                        </div>

                                        <div class="main_list_boding main_list_order_stg_lbl_name">
                            ...
                            {/foreach}
                            <div class="fn_row fn_new_label fn_sort_item main_list_body_item">
                                <div class="main_list_row fn_sort_item">
                                    <div class="cmain_list_boding main_list_check"></div>
                                    <div class="main_list_boding main_list_order_stg_lbl_name">
                                        <input type="text" class="form-control" name="new_name[]" value="">
                                    </div>
                                    <div class="main_list_boding main_list_order_stg_sts_label">
                        ...
                        <div class="main_list_footer ">
                            <div class="main_list_foot_left">
                                <div class="main_list_heading main_list_check">
                                    ...
                                    <label class="main_ckeckbox" for="check_all_4"></label>
                                </div>
                                <div class="main_list_option">
                                    <select name="action" class="selectpicker">
                                        <option value="delete">{$btr->general_delete|escape}</option>
